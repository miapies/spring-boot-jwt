...
public class JWTServiceImpl implements JWTService {
	...
	private static final String SECRET = Base64Utils.encodeToString("Alguna.Clave.Secreta.123456".getBytes());
	...
	public String create(Authentication auth) throws IOException {
		...
		String token = Jwts.builder()
				...
				.setClaims(claims).setSubject(username).signWith(SignatureAlgorithm.HS512, SECRET.getBytes())
